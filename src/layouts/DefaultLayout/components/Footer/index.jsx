      ...
      <div className={styles.footer_top}>
        ...
        <div className={styles.footer_item}>
          <div className={styles.footer_hotline}>
            ...
            />
            <p>
              Hotline <b>1900.272737 - 028.7777.2737 (8:30 - 22:00)</b>
            </p>
          </div>
        ...
        <div className={styles.footer_img}>
          ...
          <a href="">
            <img
              ...
              alt="Coolmate info"
              className={styles.footer_three}
            />
          </a>
          <a href="">
            <img
              src="https://www.coolmate.me/images/footer/logoSaleNoti.png"
              alt="Coolmate Sale Notification"
              className={styles.footer_four}
            />
          </a>
        </div>
      </div>
